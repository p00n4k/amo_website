    ...
    const fetchImages = async () => {
      try {
        ...
        if (Array.isArray(data) && data.length > 0) {
          ...
          // fallback ภาพเดิมถ้า DB ไม่มีข้อมูล
          setImages([
      ...
      <div className="quote_head">
        <div className="quote_head_content">
          <h2 className="quote_head_title">
            From the beginning to the end of your home renovation or decoration
            process,
          </h2>
          <p className="quote_head_subtitle">
            We can assure you the satisfaction with our{" "}
            <span className="italic">goods and services</span>.
          </p>
        ...
        <div className="product_focus_content">
          ...
          <div className="product_focus_image">
            ...
            <p className="text-gray-700 text-lg mb-2">
              A system of indoor & outdoor surfaces: floors, walls and decors.
              Since 1969
            </p>

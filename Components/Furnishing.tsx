// ============================================
// 📁 File: components/Furnishing.tsx (Updated)
// ============================================
'use client';
...
const Furnishing = () => {
    ...
    const fetchFocusProducts = async () => {
        try {
            ...
            const response = await fetch('/api/products/focus/furniture');
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-6 col-span-2">
                    {loading ? (
                        ...
                        focusProducts.map((product) => (
                            ...
                            >
                                <Image
                                    src={product.image || '/images/furniture.jpg'}
                                    alt={product.brandname || 'Furniture'}
                                    width={500}
                                    height={500}
                        ...
                        ['/images/furniture.jpg', '/images/furniture.jpg', '/images/furniture.jpg', '/images/furniture.jpg']
                            .map((src, idx) => (
